...
def findFactors(n, k):
    ...
    if (res is False):
        ...
        print("|\tUsing extended Euclidean algorithm to find GCD...")
        print("|\t|\tgcd(n,a+b) =", factor_1)
        print("|\t|\tgcd(n,a-b) =", factor_2)
        print("|\tTo get all prime factors...")
        prime_factors_1 = prime_factorize(factor_1)
        prime_factors_2 = prime_factorize(factor_2)

        if prime_factors_1:
            print("|\t|\tPrime factors of gcd(n,a-b): " +
                  ','.join([str(f) for f in prime_factors_1]))
        else:
            print("|\t|\tPrime factors of gcd(n,a-b): N/A")

        if prime_factors_2:
            print("|\t|\tPrime factors of gcd(n,a+b): " +
                  ','.join([str(f) for f in prime_factors_2]))
        else:
            print("|\t|\tPrime factors of gcd(n,a+b): N/A")
        ...
        print("|\tPrime factors of n using Difference of Squares method: " +
